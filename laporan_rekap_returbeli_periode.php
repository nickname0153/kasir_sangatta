...
if (isset($_POST['btnCetak'])) {
	// Buka file
	echo "<script>";
	echo "window.open('cetak/rekap_returbeli_periode.php?tglAwal=$tglAwal&tglAkhir=$tglAkhir')";
	echo "</script>";
}
?>
            ...
            <div class="col-md-7">
              <div class="page-breadcrumb-wrap">
                <div class="page-breadcrumb-info">
                  <h2 class="breadcrumb-titles">Laporan Rekap Retur Barang Per Periode</h2>
                  <ul class="list-page-breadcrumb">
                    <li><a href="#">Home</a>
                    <li ><a href="?open=Laporan-Retur">Laporan Data Retur</a></li>
                    <li class="active-page">Laporan Rekap Retur Barang Per Periode</li>
                  </ul>
                  </ul>
                </div>
              </div>
...
<br>
<a href="cetak/rekap_returbeli_periode.php?<?php echo "tglAwal=$tglAwal&tglAkhir=$tglAkhir"; ?>" target="_blank"><img src="images/btn_print2.png" height="18" border="0" title="Cetak ke Format HTML"/></a>
 | <a class="btn btn-default" href="cetak/excel/rekap_returbeli_periode_excel.php?<?php echo "tglAwal=$tglAwal&tglAkhir=$tglAkhir"; ?>" >Export ke Excel</a>
