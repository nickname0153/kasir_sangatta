            ...
            <div class="col-md-7">
              <div class="page-breadcrumb-wrap">
                <div class="page-breadcrumb-info">
                  <h2 class="breadcrumb-titles">Laporan Data Penjualan Per Periode</h2>
                  <ul class="list-page-breadcrumb">
                    <li><a href="#">Home</a>
                    <li ><a href="?open=Laporan-Penjualan">Laporan Data Penjualan</a></li>
                    <li class="active-page">Laporan Data Penjualan Per Periode</li>
                  </ul>
                  </ul>
                </div>
              </div>
...
<div class="row">
  ...
  <tr class="success">
    ...
    <td width="69" bgcolor="#CCCCCC"><strong>Tgl. Nota </strong></td>
    <td width="95" bgcolor="#CCCCCC"><strong>No. Nota  </strong></td>
    <td width="160" bgcolor="#CCCCCC"><strong>Pelanggan </strong></td>
    <td width="245" bgcolor="#CCCCCC"><strong>Keterangan</strong></td>
    <td width="63" align="right" bgcolor="#CCCCCC"><strong> Barang </strong></td>
...
<a href="cetak/penjualan_periode.php?tglAwal=<?php echo $tglAwal; ?>&tglAkhir=<?php echo $tglAkhir; ?>" target="_blank"><img src="images/btn_print2.png" height="18" border="0" title="Cetak ke Format HTML"/></a>
 | <a class="btn btn-default" href="cetak/excel/penjualan_periode_excel.php?tglAwal=<?php echo $tglAwal; ?>&tglAkhir=<?php echo $tglAkhir; ?>">Export ke Excel</a>
