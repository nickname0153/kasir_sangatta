      ...
      <tr bgcolor="<?php echo $warna; ?>">
        ...
        <td> 
			<a href="#" onClick="window.opener.document.getElementById('txtBarcode').value = '<?php echo $myData['barcode']; ?>';
                 ...
                 window.opener.document.getElementById('txtHargaA').value = '<?php echo $myData['harga_member']; ?>';
        ...
        <td align="center" bgcolor="<?php echo $warna_stok; ?>"><?php echo $myData['stok'] + $myData['stok_opname']; ?></td>
