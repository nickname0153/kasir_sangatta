...
<title>Transaksi Penjualan - TinyLite POS </title>
...
<link rel="stylesheet" type="text/css" href="../assets1/css/sweetalert.css" />
<link rel="stylesheet" type="text/css" href="../assets1/css/select2-bootstrap.css" />
<!--alert-->
...
<div class="left-aside desktop-view">
    <div class="aside-branding">
        ...
        <a href="../index.php" class="large-logo"><img style="width:183px; height:60px;" src="../assets1/images/tinylite2.png" alt="TinyLite Logo">
...
if(isset($_GET['open'])) {
  ...
  switch($_GET['open']){        
    case 'Penjualan-Baru' :
      if(!file_exists ("penjualan_baru.php")) die ("File tidak ditemukan !"); 
      include "penjualan_baru.php"; break;
    case 'Penjualan-Barcode' :
      if(!file_exists ("penjualan_barcode.php")) die ("File tidak ditemukan !"); 
      include "penjualan_barcode.php";  break;
    case 'Penjualan-Tampil' : 
      if(!file_exists ("penjualan_tampil.php")) die ("File tidak ditemukan !"); 
      include "penjualan_tampil.php"; break;
    case 'Penjualan-Hapus' : 
      if(!file_exists ("penjualan_hapus.php")) die ("File tidak ditemukan !"); 
      include "penjualan_hapus.php";  break;
    case 'Penjualan-Kasir' : 
      if(!file_exists ("penjualan_kasir.php")) die ("File tidak ditemukan !"); 
      include "penjualan_kasir.php";  break;
  }
}
else {
