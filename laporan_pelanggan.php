            ...
            <div class="col-md-7">
              <div class="page-breadcrumb-wrap">
                <div class="page-breadcrumb-info">
                  <h2 class="breadcrumb-titles">Laporan Data Pelanggan</h2>
                  <ul class="list-page-breadcrumb">
                    <li><a href="#">Home</a>
                    <li ><a href="?open=Laporan-Master-Data">Laporan Master Data</a></li>
                    <li class="active-page">Laporan Data Pelanggan</li>
                  </ul>
                  </ul>
                </div>
              </div>
...
<div class="row">
          <div class="col-md-12">
            <div class="box-widget widget-module">
                ...
                <div class="widget-block">
                   <table class="table table-bordered table-responsive" width="985" border="0" cellspacing="1" cellpadding="2">
                    <tr>
                      ...
                      <td width="166" ><strong>Nama Pelanggan </strong></td>
             ...
             | <a class="btn btn-default" href="cetak/excel/pelanggan_excel.php">Export ke Excel</a>
                </div>
                </div>
              </div>
            </div>
