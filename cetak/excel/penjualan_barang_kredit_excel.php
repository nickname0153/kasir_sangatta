...
header("Content-disposition:attachment;filename=Laporan_Penjualan_barang_kredit.xls");
...
if($_GET) {
	...
	$filterPeriode = "AND ( tgl_penjualan BETWEEN '".InggrisTgl($tglAwal)."' AND '".InggrisTgl($tglAkhir)."') AND p.keterangan = 'Kredit'";
}
else {
	$filterPeriode = " ";
}
