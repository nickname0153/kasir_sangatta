...
header("Content-disposition:attachment;filename=Laporan_Penjualan_Terlaris.xls");
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="140" bgcolor="#F5F5F5"><strong>Merek</strong></td>
    <td width="80" align="center" bgcolor="#F5F5F5"><b>Qty Terjual </b></td>
  </tr>
  <?php
	// variabel
	$jumlahJual = 0;
  ...
  <tr>
    ...
    <td align="center" bgcolor="#F5F5F5"><strong><?php echo format_angka($jumlahJual); ?></strong></td>
  </tr>
</table>