...
<html>
<head>
<title>:: Cetak Retur Pembelian | Program Minimarket</title>
...
<table width="600" border="0" cellspacing="1" cellpadding="4" class="table-print">
  ...
  <tr>
    <td><b>Tgl. Retur </b></td>
    <td><b>:</b></td>
    <td valign="top"><?php echo IndonesiaTgl2($myData['tgl_returjual']); ?></td>
  </tr>
  <tr>
    <td><b>Pelanggan</b></td>
    <td><b>:</b></td>
...
<table class="table-list" width="700" border="0" cellspacing="1" cellpadding="2">
  ...
  <?php
	...
	$mySql ="SELECT returjual_item.keterangan, returjual_item.jumlah, barang.nm_barang, barang.kd_barang 
			 FROM returjual_item 
