						...
						<div class="col-md-7">
							<div class="page-breadcrumb-wrap">
								<div class="page-breadcrumb-info">
									<h2 class="breadcrumb-titles">Data Transaksi Retur Penjualan</h2>
									<ul class="list-page-breadcrumb">
										<li><a href="#">Home</a>
										</li>
										<li ><a href="?open=Returjual-Baru">Retur Penjualan Baru</a></li>
										</li>
										<li class="active-page">Tampil Retur Penjualan </li>
									</ul>
									</ul>
								</div>
							</div>
...
<div class="row">
 	...
 	<div class="col-md-2"><strong>Bulan Retur : </strong></div>
      	<div class="col-md-2">
...
<table class="table table-responsive table-striped" width="985" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <th width="201"><strong>Pelanggan </strong></th>
