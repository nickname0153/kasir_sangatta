...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		$noTransaksi = buatKode("returjual", "RJ");
						...
						<div class="col-md-7">
							<div class="page-breadcrumb-wrap">
								<div class="page-breadcrumb-info">
									<h2 class="breadcrumb-titles">Retur Penjualan Barang</h2>
									<ul class="list-page-breadcrumb">
										<li><a href="#">Home</a>
										</li>
										<li class="active-page">Retur Penjualan Baru</li>
										</li>
										<li><a href="?open=Returjual-Tampil">Tampil Retur Penjualan</a> </li>
									</ul>
									</ul>
								</div>
							</div>
							...
							<div class="widget-container">
								<div class=" widget-block">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<select name="cmbpelanggan" class="form-control">
							...
							<div class="widget-container">
								<div class=" widget-block">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="txtBarcode" class="form-control" id="txtBarcode" size="30" maxlength="20" value="<?php echo $kodeBarcode; ?>" onchange="javascript:submitform();" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-4 control-label">Nama Barang</label>
											<div class="col-lg-6">
												<input name="txtNama" id="txtNama" class="form-control" size="80" maxlength="200" value="<?php echo $namaBarang; ?>" readonly="readonly"/>
											</div>
											<div class="col-lg-2">
									<a href="../?open=Cari-Barang-Retur&popup=yes" onclick="javascript:void window.open('../?open=Cari-Barang-Retur&popup=yes','1444475672556','width=700,height=500,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><b>Cari Barang</b></a>
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-4 control-label">Keterangan</label>
										...
										<div class="form-group">
											...
											<div class="col-lg-6">
												<input class="form-control" name="txtJumlah" class="form-control" size="4" maxlength="4" value="1" 
												 onblur="if (value == '') {value = '1'}" 
												 onfocus="if (value == '1') {value =''}"/>
												 </div>
												 <div class="col-lg-2">
												 <input name="btnTambah" type="submit" class="btn btn-success btn-sm" style="cursor:pointer;" value=" Tambah " />
												 </div>
										</div>
...
<div class="col-md-12">
  ...
  <table class="table table-striped table-responsive" width="800" border="0" cellspacing="1" cellpadding="2" >
